...
import DrawMainChart from '../../custom/DrawMainChart';
// import map from '../../custom/map'
// import DrawGraph from '../../custom/DrawGraph';


var plots = require('../../custom/data/plots');
...
// const getData = () => {
//   var data = useStoreState(state=>state.data);
//   var allPredicted = [data[0].predicted_Usage,data[1].predicted_Usage,data[2].predicted_Usage,data[3].predicted_Usage];
// }
